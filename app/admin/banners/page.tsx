...
const PLACEMENTS = [
  { value: 'homepage_top', label: 'Homepage - Top (below stats)' },
  { value: 'homepage_mid', label: 'Homepage - Middle (above categories)' },
  { value: 'browse_top', label: 'Browse - Top (below header)' },
  { value: 'browse_mid', label: 'Browse - Bottom (below listings)' },
];
                ...
                <div className="flex-1 p-4">
                  <div className="flex items-start justify-between gap-3">
                    <div>
                      ...
                      {banner.user && (
                        <p className="text-xs text-tropical-purple mt-0.5">
                          By: {banner.user.name} ({banner.user.email})
                        </p>
                      )}
