...
export function Navbar() {
  ...
  return (
    <nav className="bg-gradient-to-r from-trini-red via-trini-black to-trini-red sticky top-0 z-50 shadow-lg w-full relative" ref={menuRef}>
      ...
      >
        <Link href="/" onClick={() => setIsOpen(false)} className="flex items-center gap-2 py-2.5 text-white font-medium hover:text-trini-gold transition-colors">
          <Home className="w-4 h-4" /> Home
        </Link>
        <Link href="/browse" onClick={() => setIsOpen(false)} className="flex items-center gap-2 py-2.5 text-white font-medium hover:text-trini-gold transition-colors">
          <Search className="w-4 h-4" /> Browse
        </Link>
        <Link href="/dashboard" onClick={() => setIsOpen(false)} className="flex items-center gap-2 py-2.5 text-white font-medium hover:text-trini-gold transition-colors">
          <Package className="w-4 h-4" /> Listings
        </Link>
        <Link href="/dashboard/messages" onClick={() => setIsOpen(false)} className="flex items-center gap-2 py-2.5 text-white font-medium hover:text-trini-gold transition-colors">
          <MessageSquare className="w-4 h-4" /> Messages
        </Link>
        <Link href="/dashboard/swaps" onClick={() => setIsOpen(false)} className="flex items-center gap-2 py-2.5 text-white font-medium hover:text-trini-gold transition-colors">
          <RefreshCw className="w-4 h-4" /> Swaps
        </Link>
        <Link href="/dashboard/wishlist" onClick={() => setIsOpen(false)} className="flex items-center gap-2 py-2.5 text-white font-medium hover:text-trini-gold transition-colors">
          <Heart className="w-4 h-4" /> Wishlist
        </Link>
        <Link href="/dashboard/settings" onClick={() => setIsOpen(false)} className="flex items-center gap-2 py-2.5 text-white font-medium hover:text-trini-gold transition-colors">
          <Settings className="w-4 h-4" /> Settings
        </Link>
        <Link href="/contact" onClick={() => setIsOpen(false)} className="flex items-center gap-2 py-2.5 text-white font-medium hover:text-trini-gold transition-colors">
          <Mail className="w-4 h-4" /> Contact Us
        </Link>
        {isAdmin && (
          <Link href="/admin" onClick={() => setIsOpen(false)} className="flex items-center gap-2 py-2.5 text-white font-medium hover:text-trini-gold transition-colors">
